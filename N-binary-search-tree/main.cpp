...
#include "ArbolBinarioBusquedaAVL.h"
...
int main() {
    ...
    //creando referencia a instancia de tipo "ArbolBinarioBusquedaAVL"
    ArbolBinarioBusquedaAVL<CPerson*>* arbol = new ArbolBinarioBusquedaAVL<CPerson*>(
